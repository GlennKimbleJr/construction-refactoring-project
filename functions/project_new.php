				...
				?>
					...
					<h3>Start a New Project</h3>
						<form action="" method="POST">
							...
							<input id="name" type="text" name="name" required placeholder="Joe Bob's Remodel" /></p>
    							<p><label>Plan Directory Name: </label>
							<input size='35' id="plans" type="text" name="plans" required placeholder="dunkin_donut" /></p>
    							<p><label>Directory Login: </label>
							<input size='10' id="planuser" type="text" name="planuser" required placeholder="user" />
							<input size='10' id="planpass" type="text" name="planpass" required placeholder="pass" /></p>
    							<p><label>Owner Contact: </label><br>
							<input id="owner_name" type="text" name="owner_name" required placeholder="Name" />
							<input id="owner_phone" type="text" name="owner_phone" required placeholder="Phone" /></p>

    							<p><label>Bid Due By: </label>
							<select name="due1">
							...
							<input id="due3" type="text" name="due3" required placeholder="2014" maxlength="4" size="4"/></p>
	 
							<p><label>Zone: <a href='' rel='imgtip[0]'><b><u>VIEW MAP</u></b></a></label><br>
								<select name="zone">	
								<?php 
							...
							<p><label>Select Superintendent:</label><br>
								<select name="super">	
								<option value=""></option>	
								<?php 
							...
							<input id="location" type="text" name="location" required placeholder="City, State" /></p>
