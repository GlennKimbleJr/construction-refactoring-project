...
<input id="id2" type="hidden" name="id2" required value="<?php echo"$did"; ?>" />
							<input id="name" type="text" name="name" required value="<?php echo"$Mname"; ?>" /></p>
    							<p><label>Plans Directory Name: </label>
							<input size='35' id="plans" type="text" name="plans" required value="<?php echo"$Mplans"; ?>" /></p>
    							<p><label>Directory Login: </label>
							<input size='10' id="planuser" type="text" name="planuser" required value="<?php echo"$Mplanuser"; ?>" />
							<input size='10' id="planpass" type="text" name="planpass" required value="<?php echo"$Mplanpass"; ?>" /></p>
							...
							<input id="owner_phone" type="text" name="owner_phone" required placeholder="Phone" value="<?php echo"$Mowner_phone"; ?>"/></p>
							...
							<input id="due3" type="text" name="due3" required value="<?php echo"$date3"; ?>" maxlength="4" size="4"/></p>
							...
							<input id="location" type="text" name="location" required value="<?php echo"$Mlocation"; ?>" /></p>
