				...
				?>
					...
					<h3>New Contact</h3>
						<form action="" method="POST">
							...
							<input id="company" type="text" name="company" required placeholder="Construction Company" size='24'/></p>
    							<p><label>Name: </label>
							<input id="first" type="text" name="first" placeholder="Lloyd" size='8'/>
							<input id="last" type="text" name="last" placeholder="Martin"  size='14'/></p>
							...
							<input id="zip" type="text" name="zip" placeholder="90210" maxlenght='5' size='5'/></p>
    							<p><label>Email Address: </label>
							<input id="email" type="text" name="email" required placeholder="bob@email.com" size='24'/></p>
    							<p><label>Office Phone: </label>
							<input id="officephone" type="text" name="officephone" placeholder="(555) 555-5555" /></p>
    							<p><label>Cell Phone: </label>
							<input id="cellphone" type="text" name="cellphone" placeholder="(555) 555-5555" /></p>
    							<p><label>Fax Number: </label>
							<input id="fax" type="text" name="fax" placeholder="(555) 555-5555" /></p>





							<p><label>Zone: <b>Choose up to 9</b> | <a href='' rel='imgtip[0]'><b><u>VIEW MAP</u></b></a><br></label>
								<select name="zone">	
								<?php 
