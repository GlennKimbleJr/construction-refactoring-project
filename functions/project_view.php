<?php 
		...
		// Starts Script
			...
			echo "<h3>View All Projects - <a href='?open'><u>Open Only</u></a> | <a href='?closed'><u>Closed Only</u></a></h3>
...
<div id='pagenation'>";
		...
		while($selectusercheck_row = mysql_fetch_array($selectusercheck_works, MYSQL_ASSOC)){
			...
			echo "<div class='z'><a href='?details=$id'>$name</a> - $datedate | <a href='?edit=$id'>EDIT</a></div>";
		}
